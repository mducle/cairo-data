...
uimenu(hfile,'label','Help',...
		'callback','disp(''URL http://www.ill.fr/tas/matlab/doc/mfit4/index.html''); web(''www.ill.fr/tas/matlab/doc/mfit4/index.html'')',...
		'Separator','on');
uimenu(hfile,'label','About...',...
		'callback','mf_opt(''about'');');
...
if ~exist(inifile) & ~strcmp(inifile,'mfit.ini')
...
if exist('ssym')
	uimenu(hext,'Label','SSym',...
	'Callback','mf_opt(''linksym'');');
end
if exist('rescal')
uimenu(hext,'Label','Rescal',...
	'Callback','rescal;');
end
if exist('mview')
uimenu(hext,'Label','Mview',...
	'Callback','mview;');
end
