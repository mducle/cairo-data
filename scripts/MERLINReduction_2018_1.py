...
#---------------------------------------------------------------------------#
      ...
      # multiple energies provided in the data file
       ei=[120,62,38,25] #[150,64,36] # multiple energies provided in the data file
       ...
       prop['sample_run'] = runs[efoc]
       #['40873.n001']#[40595,40596,40597,40598,40599,40600,40601,40602,40603,40604] #range(24003,24011) # 'MER23700.n001'
       prop['wb_run'] = '39323.raw'
       #
...
#------------------------------------------------------------------------------------#
   ...
   def def_advanced_properties(self):
      ...
      """
      prop = {}
      prop['map_file'] = 'rings_181.map' #'one2one_164.map'
      prop['det_cal_file'] = 'det_corr_181_process_5.dat' #'det_corrected7.nxs - testing'
      ...
      prop['hardmaskPlus']='Mask_181.xml' # Use diag (hardmaskPlus option) to enhance hard masks
      ...
      prop['monovan_mapfile'] = 'rings_181.map'
...
#------------------------------------------------------------------------------------#
   ...
   def set_custom_output_filename(self):
      ...
      def custom_name(prop_man):
            ...
            name = "MER{0}_Ei{1:<3.2f}meV_Rings".format(run_num ,ei)
            return name
